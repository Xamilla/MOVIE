...
$sql = "SELECT movie_id, movie_name, price, movie_director, movie_summary, movie_picture, movie_quantity, duration, released, cast
        FROM movies WHERE categories = 'superheros'";
    ...
    <div class="movie-grid">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<img src="../MOVIE/images/superheros/' . $picture . '" alt="' . $movie_name . '">';
                echo '</div>';
            ...
            echo '<div class="no-movies"><p>No superheros movies available at this time.</p></div>';
        }
