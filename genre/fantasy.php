...
<div class="comedy-container">
    <h1>Fanstasy Movie</h1>
    <div class="movie-grid">
        <?php
        include 'database/moviesdb.php';
        $movie_db = new Database();
        // Fetch movies from the database
        $sql = "SELECT movie_name, price,movie_director, movie_summary,movie_picture,movie_quantity,duration FROM movies WHERE categories = 'fantasy'";
